...
function [left_eye, right_eye, vfac, mindur, degperpix, smooth, globalthresh, clusterdist, clustermode, plotfig, writesac, writefix, keepepochs] = dlg_detecteyemovements(callingFcn,chanlocs,srate)

geometry = { 1 [2 0.8 0.5] [2 0.8 0.5] [2 0.8 0.5] [2 0.8 0.5] [2 0.8 0.5] 1 1 [2 0.8 0.5] [2 0.8 0.5] [2 0.8 0.5] [2 0.8 0.5] [2 0.8 0.5] [2 1.3] 1 1 [2 1.3] [2 1.3] [2 1.3] [2 1.3] };
...
uilist = {...
    ...
    ...
    {'Style', 'text', 'string', 'Keep bad epochs?'},...
    {'Style', 'checkbox','value', 1, 'tag','keepepochs'},...
    ...
...
keepepochs   = outstruct.keepepochs;
